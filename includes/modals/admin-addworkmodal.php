...
<!-- Add Work Modal  -->
<div class="modal modal-lg fade " id="admin-addworkmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6  mt-2">
                            ...
                            <div class="row overflow-auto">
                                ...
                                <input type="hidden" id="addedby" name="addedby" value=0>
                                <input type="hidden" id="numberofusers" name="numberofusers" value="<?= $peruser ?>">
                                <input type="hidden" id="addedfrom" name="addedfrom" value="admin">
                            </div>
                        </div>
                    </div>
                </div>
