...
class allfetchnrofwork extends connectiontodb
{
    ...
    {
        $this->user_nrofactiveworkload = $this->allUsertotalactiveWorkload();
        $this->user_nrofactiveworkload = $this->allUsertotalunupdatedWorkload();
        $this->user_nrofactiveworkload = $this->allUsertotaldeadlineWorkload();
        $this->user_allworkadded = $this->allworkadded();
        $this->user_allcompliedworkadded = $this->allcompliedworkadded();
    }


    public function allUsertotalactiveWorkload()
    {
    ...
    public function allUsertotalunupdatedWorkload()
    {
        $sqlviewwork = "SELECT * FROM work_queue";
        $workQueue = $this->connect()->query($sqlviewwork) or die($this->connect()->error);
        $eachwork = $workQueue->fetch_assoc();
    ...
    public function allUsertotaldeadlineWorkload()
    {
        $sqlviewwork = "SELECT * FROM work_queue";
        $workQueue = $this->connect()->query($sqlviewwork) or die($this->connect()->error);
        $eachwork = $workQueue->fetch_assoc();
